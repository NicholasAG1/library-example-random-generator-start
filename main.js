...
function randomNumber() {
    ...
    if (selection == 'dec0to1') {
        ...
        outputEl.innerHTML = Math.randomDec(0, 50);
    } else if (selection == 'dec-10to10') {
        outputEl.innerHTML = Math.randomDec(-10, 10);
    } else if (selection == 'int0to5') {
        outputEl.innerHTML = Math.randomInt(0, 5);
    } else if (selection == 'int1to11') {
        outputEl.innerHTML = Math.randomInt(1, 11);
    }
}
